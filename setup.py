...
#
# However, when we do this, we also import `mold_data/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'mold_data_cli = mold_data.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'mold_data_gui = mold_data.gui:entry_point'
        # ]
    }
)
